package com.brews.cafeorderingapp.adapter;
...
import com.brews.cafeorderingapp.databinding.CartItemBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    DatabaseReference databaseReference = firebaseDatabase.getReference("newcart");
