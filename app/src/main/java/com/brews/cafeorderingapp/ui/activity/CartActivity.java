...
import com.brews.cafeorderingapp.adapter.CartAdapter;
...
import com.brews.cafeorderingapp.room.CartDatabase;
...
//        }
        ...
        databaseReference = firebaseDatabase.getReference("newcart").child(firebaseUser);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                double cgst = (double) (total * 9) / 100;
                double sgst = (double) (total * 9) / 100;
                ...
                checkout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Order order = new Order(orderId, grandTotal, orderArrayList, new Date().toString());
                        ...
                        reference.child(uniqueKey).setValue(order).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                ...
                                intent.putExtra("orderID", uniqueKey);
...
//        });
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(CartActivity.this, NewMenu.class);
